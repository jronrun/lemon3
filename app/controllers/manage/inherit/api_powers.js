...
module.exports = function (router, index, root) {
  ...
  var serverLabel = [
    'Define',
    generic.listChooseBtn('plus', 'Add', getAction(root.server, 1), 1, 'server.define'),
    generic.listChooseBtn('eye', 'View', getAction(root.server, 1), 2, 'server.define')
  ].join(' ');
  ...
  var interfaceLabel = [
    'Define',
    generic.listChooseBtn('plus', 'Add', getAction(root.interface, 1), 1, 'interface.define'),
    generic.listChooseBtn('eye', 'View', getAction(root.interface, 1), 2, 'interface.define')
  ].join(' ');
